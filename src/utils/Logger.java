...
public abstract class Logger {
	...
	/**
	 * Sets whether the logger prints messages to the console. Can be called while a log file
	 * is active.
	 * @param turnDebugOn if true, print future statements to console; if false, 
	 * write future statements to file only.
	 */
	 ...
	 * @param filename address of the target log file
	 */
	public static void openFileForLogging(String filename) {
		...
		try {
			...
			System.out.println("Exception while initializing logfile: "+filename+"\nAborting logging.");
			if(Logger.PW != null) {
				Logger.PW.close();
			}
			Logger.PW = null;
	...
	/**
	 * Initializes a log file in the default directory (logs). The name of the logfile
	 * is 
	...
	/**
	 * Writes a log message to file without starting a new line.
	 * If Logger.DEBUG is true, prints the message to the console
	 * as well.
	 * 
	...
	/**
	 * Writes a log message to file and starts a new line
	 * If Logger.DEBUG is true, prints the message to the console
	 * as well.
	 * 
	 * @param statement the message to print
