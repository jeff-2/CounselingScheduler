...
/**
 * Editable component displaying the clinicians assigned to EC sessions for one
 * week.
 * 
...
public class ECWeeklyComponent extends JPanel implements ActionListener {
    ...
    /**
     * Creates a component that displays the clinicians assigned to EC sessions
     ...
     */
    public ECWeeklyComponent(ECScheduleWeekBean week,
	    Vector<String> clinicianNames, Schedule schedule) {
	...
	for (int r = 0; r < cells.size(); r++) {
		...
		if (r == 0 || c == 0) {
		    ...
		    JComboBox<String> assignedClinician = new JComboBox<String>(
			    clinicianNames);
		    String key = cells.get(0).get(c) + ", "
			    + cells.get(r).get(0);
		    ...
		    assignedClinician.putClientProperty("Month",
			    week.monthAbbrev());
		    assignedClinician.putClientProperty("Day", cells.get(0)
			    .get(c).split(" ")[1]);
		    assignedClinician.putClientProperty("Time", cells.get(r)
			    .get(0));
	...
	String month = (String) ((JComboBox<String>) e.getSource())
		.getClientProperty("Month");
	String day = (String) ((JComboBox<String>) e.getSource())
		.getClientProperty("Day");
	String time = (String) ((JComboBox<String>) e.getSource())
		.getClientProperty("Time");
	String clinicianName = ((JComboBox<String>) e.getSource())
    ...
    /**
     * Gets the time represented by the string.
     *
     * @param time the time as a string
     * @return the time as an int (24 hour time)
     */
	...
	String date = month + " " + day + ", "
		+ (schedule.getCalendar().getStartDate().getYear() + 1900);
