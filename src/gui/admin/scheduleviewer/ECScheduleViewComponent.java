 ...
 *
 */
public class ECScheduleViewComponent extends JComponent implements Printable {
	 ...
	 */
	private ArrayList<ECScheduleWeekViewBean> weeks;
	
	public ECScheduleViewComponent(ArrayList<ECScheduleWeekViewBean> myWeeks) {
		weeks = myWeeks;
		title = "";
		first = false;
	...
	public ECScheduleViewComponent(ArrayList<ECScheduleWeekViewBean> myWeeks, String myTitle) {
		weeks = myWeeks;
		title = myTitle;
		first = true;
	...
	public void paint (Graphics g1) {
		...
		for(ECScheduleWeekViewBean bean : this.weeks) {
	...
	private int drawWeek(Graphics2D g, int x, int y, ECScheduleWeekViewBean bean) {
		int xoffset = x+25;
		int yoffset = y+50;
