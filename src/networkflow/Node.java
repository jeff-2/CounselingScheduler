...
public class Node {
	...
	/**
	 * Creates a new edge (with provided capacity) to node 
	 * 'end' if one does not already exist,
	 * else adds capacity to the existing edge.
	 */
	public void createEdgeTo(Node end, int capacity) {
		...
		if(e == null) {
			...
			this.outgoing.put(end, e);
										...
										// doesn't have an incoming edge to this node already
		}
		else {
