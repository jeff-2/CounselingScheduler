...
public final class Utility {
	...
	/**
	 * Parses the integer from the given string. If it is invalid, throws InvalidFormDataException 
	 * with fieldname and context.
	 *
	 * @param text the text
	 ...
	 */
	public static int parseInt(String text, String field, String context) throws InvalidFormDataException {
		int value;
	...
	/**
	 * Parses the time represented in timeString of the format (\d{1,2}:\d{2}[a,p]m). Rounds down
	 * to the nearest hour, unless roundUp is specified, in which it will round up to the nearest hour.
	 *
	 * @param timeString the time string
	 * @param roundUp whether or not to round up
	 * @return the int representing the (rounded) 24 hour time of the given time string
	 */
