...
/**
 * The Enum Weekday represents the weekdays in a week. Provides utilities for converting to and from
 * different representations (e.g. string, date) to a Weekday and back.
 *
...
public enum Weekday {
	...
	/**
	 * Gets the weekday represented by a particular date. Throws IllegalArgumentException if
	 * the provided date is not a weekday
	 *
	 * @param d the d
	 * @return the weekday
	 */
