...
/**
 * The Class Commitment is used in order to aggregate a set of commitments with
 * different dates that all refer to the same commitment.
 */
public class Commitment {
	...
	return id == commitment.id && startHour == commitment.startHour
		&& endHour == commitment.endHour
		&& description.equals(commitment.description)
		&& dayOfWeek.equals(commitment.dayOfWeek);
    }
