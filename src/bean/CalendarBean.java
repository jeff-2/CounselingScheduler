...
/**
 * Represents the calendar parameters that an administrator creates when
 * entering setting for a new semester
 * 
 * @author nbeltr2
 * @author dtli2
 */
public class CalendarBean {
	 ...
	 * @param semester
	 *            the semester
	 * @param meetingFilepath
	 *            the meeting filepath
	 */
	public CalendarBean(int id, Date startDate, Date endDate, int iaMinHours,
			int ecMinHours, Semester semester, String meetingFilepath) {
		this.id = id;
	...
	public boolean equals(Object other) {
		...
		return id == calendar.id && startDate.equals(calendar.startDate)
				&& endDate.equals(calendar.endDate)
				&& iaMinHours == calendar.iaMinHours
				&& ecMinHours == calendar.ecMinHours
