...
/**
 * The Class SessionNameBean provides storage of session info for a particular clinician.
 */
public class SessionNameBean {
	 ...
	 * @param sSessionID the s session id
	 */
	 ...
	 *
	 * @param clinicianName the new clinician name
	 */
