...
/**
 * The Class Commitment handles the storage of data for a particular clinician's
 * commitment.
 * 
...
public class CommitmentBean {
	...
	public String toString() {
		return OperatingHours.toString(startHour) + " " + Weekday.dayName(date)
				+ " " + description;
	}
	...
	public boolean equals(Object other) {
		...
		return clinicianID == commitment.clinicianID
				&& startHour == commitment.startHour
				&& endHour == commitment.endHour
				&& date.equals(commitment.date)
