...
public class DBUtils {
	...
	/**
	 * Load connection config from the default config file. Returns connection
	 * url specified by connection config file.
	 *
	 * @return the string
	 * @throws ConnectionConfigException
	 *             the connection config exception
	 */
	public static String loadConnectionConfig()
			throws ConnectionConfigException {
		return loadConnectionConfig(CONFIG_FILEPATH);
	}

	/**
	 * Load connection config from the specified config file. Returns connection
	 * url specified by connection config file.
	 *
	 * @param filePath
	 *            the file path
	 ...
	 *             the connection config exception
	 */
	public static String loadConnectionConfig(String filePath)
			throws ConnectionConfigException {
