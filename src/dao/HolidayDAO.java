...
public class HolidayDAO extends DAO {
	 ...
	 *            the Holiday to add
	 * @param calendarId
	 *            the id of the Calendar that the holiday is associated with
	 * @param id
	 *            the id of the holiday
	 * @throws SQLException
	 *             the SQL exception
	 */
	public void insertHoliday(HolidayBean holiday, int calendarId, int id)
			throws SQLException {
		PreparedStatement stmt = connection
				.prepareStatement("INSERT INTO Holiday(id, calendarId, "
	...
	public List<HolidayBean> loadHolidays() throws SQLException {
		PreparedStatement stmt = connection
				.prepareStatement("SELECT * FROM Holiday");
		stmt.execute();
