...
/**
 * The Class ClinicianFormTest tests the full functionality of the
 * ClinicianForm.
 *
...
public class ClinicianFormTest extends UISpecTestCase {
	...
	protected void setUp() throws Exception {
		super.setUp();
		setAdapter(new MainClassAdapter(ClinicianFormRunner.class,
				new String[0]));
		...
		commitments.add(new CommitmentBean(0, 8, 9, DateRangeValidator
				.parseDate("3/25/2015"), "desc"));
		commitments.add(new CommitmentBean(0, 8, 9, DateRangeValidator
				.parseDate("4/1/2015"), "desc"));
		commitments.add(new CommitmentBean(0, 8, 9, DateRangeValidator
				.parseDate("4/8/2015"), "desc"));
		commitments.add(new CommitmentBean(0, 8, 9, DateRangeValidator
				.parseDate("4/15/2015"), "desc"));
		commitments.add(new CommitmentBean(0, 8, 9, DateRangeValidator
				.parseDate("4/22/2015"), "desc"));
		commitments.add(new CommitmentBean(0, 10, 11, DateRangeValidator
				.parseDate("3/30/2015"), "other desc"));
		commitments.add(new CommitmentBean(0, 10, 11, DateRangeValidator
				.parseDate("4/6/2015"), "other desc"));
		commitments.add(new CommitmentBean(0, 10, 11, DateRangeValidator
				.parseDate("4/13/2015"), "other desc"));
		commitments.add(new CommitmentBean(0, 10, 11, DateRangeValidator
				.parseDate("4/20/2015"), "other desc"));
		commitments.add(new CommitmentBean(0, 10, 11, DateRangeValidator
				.parseDate("4/27/2015"), "other desc"));

		timeAway = new ArrayList<TimeAwayBean>();
		timeAway.add(new TimeAwayBean(0, "some desc", DateRangeValidator
				.parseDate("1/3/1970"), DateRangeValidator
				.parseDate("1/12/1970")));
		timeAway.add(new TimeAwayBean(0, "some other desc", DateRangeValidator
				.parseDate("1/3/1970"), DateRangeValidator
				.parseDate("1/6/1970")));
	}
	...
	public void testClearField() throws Exception {
		...
		TextBox commitmentDescription = window
				.getTextBox("commitmentDescription");
	...
	/**
	 * Test submit clinician form with external commitment and biweekly
	 * frequency.
	 *
	 * @throws Exception
	 *             the exception
	...
	public void testInsertClinicianFormExternalB() throws Exception {
		...
		expectedCommitments.add(new CommitmentBean(0, 7, 10, DateRangeValidator
				.parseDate("4/1/2015"), "desc"));
		expectedCommitments.add(new CommitmentBean(0, 9, 12, DateRangeValidator
				.parseDate("4/6/2015"), "other desc"));
	...
	public void testInsertClinicianFormBiweekly() throws Exception {
		...
		List<CommitmentBean> expectedCommitments = new ArrayList<CommitmentBean>();
		expectedCommitments.add(new CommitmentBean(0, 8, 9, DateRangeValidator
				.parseDate("3/25/2015"), "desc"));
		expectedCommitments.add(new CommitmentBean(0, 8, 9, DateRangeValidator
				.parseDate("4/8/2015"), "desc"));
		expectedCommitments.add(new CommitmentBean(0, 8, 9, DateRangeValidator
				.parseDate("4/22/2015"), "desc"));
		expectedCommitments.add(new CommitmentBean(0, 10, 11,
				DateRangeValidator.parseDate("3/30/2015"), "other desc"));
		expectedCommitments.add(new CommitmentBean(0, 10, 11,
				DateRangeValidator.parseDate("4/13/2015"), "other desc"));
		expectedCommitments.add(new CommitmentBean(0, 10, 11,
				DateRangeValidator.parseDate("4/27/2015"), "other desc"));
	...
	public void testInsertClinicianFormMonthly() throws Exception {
		...
		expectedCommitments.add(new CommitmentBean(0, 8, 9, DateRangeValidator
				.parseDate("4/1/2015"), "desc"));
		expectedCommitments.add(new CommitmentBean(0, 10, 11,
				DateRangeValidator.parseDate("4/6/2015"), "other desc"));
	...
	/**
	 * Inserts clinician preferences into form and submits with specified
	 * frequency and whether it is external or not.
	 *
	 * @param frequency
	 *            the frequency
	 * @param isExternal
	...
	public void testUpdateClinicianForm() throws Exception {
		...
		ClinicianPreferencesBean otherPreferences = new ClinicianPreferencesBean(
				0, 3, 1, 2, 35, 44);
		List<CommitmentBean> otherCommitments = new ArrayList<CommitmentBean>();
		otherCommitments.add(new CommitmentBean(0, 15, 16, DateRangeValidator
				.parseDate("3/25/2015"), "pear"));
		otherCommitments.add(new CommitmentBean(0, 15, 16, DateRangeValidator
				.parseDate("4/1/2015"), "pear"));
		otherCommitments.add(new CommitmentBean(0, 15, 16, DateRangeValidator
				.parseDate("4/8/2015"), "pear"));
		otherCommitments.add(new CommitmentBean(0, 15, 16, DateRangeValidator
				.parseDate("4/15/2015"), "pear"));
		otherCommitments.add(new CommitmentBean(0, 15, 16, DateRangeValidator
				.parseDate("4/22/2015"), "pear"));
		List<TimeAwayBean> otherTimeAway = new ArrayList<TimeAwayBean>();
		otherTimeAway.add(new TimeAwayBean(0, "a desc", DateRangeValidator
				.parseDate("1/3/2000"), DateRangeValidator
				.parseDate("1/12/2000")));
